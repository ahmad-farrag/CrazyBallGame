...
void ACrazyBallGameGameModeBase::BeginPlay()
{
	Super::BeginPlay();
...
void ACrazyBallGameGameModeBase::Tick(float deltaSeconds)
{
	...
	//TODO Remove GetAllActorsOfClass since it's generally not great for performance, but OK right here.
